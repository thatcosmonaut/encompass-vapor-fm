...
export class TransformObjectEngine extends Engine {
    public update(dt: number) {
        ...
        for (const rotate_object_message of rotate_object_messages.iterable()) {
            ...
            if (component.mesh !== undefined) {
                rotate_object_message.component.mesh.rotate(Vector3.Right(), rotate_object_message.x, Space.LOCAL);
                rotate_object_message.component.mesh.rotate(Vector3.Up(), rotate_object_message.y, Space.LOCAL);
                rotate_object_message.component.mesh.rotate(Vector3.Forward(), rotate_object_message.z, Space.LOCAL);
            }
        }
    }
}
